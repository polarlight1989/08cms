...
if($action == 'txjyr'){
	if(!submitcheck('bmconfigs')){
		tabheader('特许经营人','cfsite',"?entry=extend&extend={$extend}&action=save",2,1);
		trspecial('','mconfigsnew[txjyr]',$mconfigs['txjyr'],'htmltext');
		tabfooter('bmconfigs');
	}
} 
if($action == 'apply'){
	if(!submitcheck('bmconfigs')){
		tabheader('通知邮箱','cfsite',"?entry=extend&extend={$extend}&action=save",2,1);
		trbasic('通知邮箱','mconfigsnew[informEmail]',$mconfigs['informEmail'],'btext','接收在线申请的邮箱地址，支持多个（用 | 分割）');
		tabfooter('bmconfigs');
	}
} 
if($action == 'save'){
	saveconfig('site');
	amessage('保存成功！',M_REFERER);
}
if($action == 'index'){
	tabheader('首页内容设置','cfsite',"?entry=extend&extend={$extend}&action=save",2,1);
	trbasic('网站名称','mconfigsnew[cmsname]',$mconfigs['cmsname'],'btext');
	trspecial('logo','mconfigsnew[logo]',$mconfigs['logo'],'image','','大小 ：宽160px 高70px');
	trbasic('版权信息','mconfigsnew[zh_mcopyright]',$mconfigs['zh_mcopyright'],'textarea');
			tabfooter('');
 
			tabheader('幻灯片 大小：1200x700');
			trspecial('幻灯片1','mconfigsnew[mfocus1_img]',$mconfigs['mfocus1_img'],'image');
			trbasic('幻灯片1链接','mconfigsnew[mfocus1_href]',$mconfigs['mfocus1_href'],'btext');
			trspecial('幻灯片2','mconfigsnew[mfocus2_img]',$mconfigs['mfocus2_img'],'image');
			trbasic('幻灯片2链接','mconfigsnew[mfocus2_href]',$mconfigs['mfocus2_href'],'btext');
			trspecial('幻灯片3','mconfigsnew[mfocus3_img]',$mconfigs['mfocus3_img'],'image');
			trbasic('幻灯片3链接','mconfigsnew[mfocus3_href]',$mconfigs['mfocus3_href'],'btext');
			trspecial('幻灯片4','mconfigsnew[mfocus4_img]',$mconfigs['mfocus4_img'],'image');
			trbasic('幻灯片4链接','mconfigsnew[mfocus4_href]',$mconfigs['mfocus4_href'],'btext');
			trspecial('幻灯片5','mconfigsnew[mfocus5_img]',$mconfigs['mfocus5_img'],'image');
			trbasic('幻灯片5链接','mconfigsnew[mfocus5_href]',$mconfigs['mfocus5_href'],'btext');
			tabfooter('');
			tabheader('酸奶DIY 大小：400x415');
			trspecial('图片1','mconfigsnew[sn1_img]',$mconfigs['sn1_img'],'image');
			trbasic('图片1链接','mconfigsnew[sn1_href]',$mconfigs['sn1_href'],'btext');
			trspecial('图片2','mconfigsnew[sn2_img]',$mconfigs['sn2_img'],'image');
			trbasic('图片2链接','mconfigsnew[sn2_href]',$mconfigs['sn2_href'],'btext');
			trspecial('图片3','mconfigsnew[sn3_img]',$mconfigs['sn3_img'],'image');
			trbasic('图片3链接','mconfigsnew[sn3_href]',$mconfigs['sn3_href'],'btext');
			trspecial('轮播图片1','mconfigsnew[lb_img1]',$mconfigs['lb_img1'],'image');
			trspecial('轮播图片2','mconfigsnew[lb_img2]',$mconfigs['lb_img2'],'image');
			trspecial('轮播图片3','mconfigsnew[lb_img3]',$mconfigs['lb_img3'],'image');
			trspecial('轮播图片4','mconfigsnew[lb_img4]',$mconfigs['lb_img4'],'image');
			trspecial('轮播图片5','mconfigsnew[lb_img5]',$mconfigs['lb_img5'],'image');
			tabfooter('');
			tabheader('视频');
			trbasic('说明','','视频及背景图尺寸：1200x600,请上传flv格式视频。','label');
			trspecial('视频背景图','mconfigsnew[video1_img]',$mconfigs['video1_img'],'image');
			trspecial('视频','mconfigsnew[video1]',$mconfigs['video1'],'flash');
			tabfooter('');
			tabheader('底部图片');
			trbasic('说明','','图片尺寸：600x410','label');
			trspecial('图片1','mconfigsnew[bpic1_img]',$mconfigs['bpic1_img'],'image');
			trbasic('图片1链接','mconfigsnew[bpic1_href]',$mconfigs['bpic1_href'],'btext');
			trspecial('图片2','mconfigsnew[bpic2_img]',$mconfigs['bpic2_img'],'image');
			trbasic('图片2链接','mconfigsnew[bpic2_href]',$mconfigs['bpic2_href'],'btext');
			tabfooter('');
			tabheader('导航');
			trbasic('说明','','图片尺寸：687x57','label');
			trspecial('图片','mconfigsnew[navpic_img]',$mconfigs['navpic_img'],'image');
			trbasic('图片链接','mconfigsnew[navpic_href]',$mconfigs['navpic_href'],'btext');
			tabfooter('');
			tabheader('其他');
			trbasic('版权','mconfigsnew[copyright]',$mconfigs['copyright'],'textarea');
			trbasic('特许经营热线','mconfigsnew[txjy]',$mconfigs['txjy'],'text');
			trspecial('微信图片','mconfigsnew[wx_img]',$mconfigs['wx_img'],'image');
			trbasic('微博地址','mconfigsnew[wb_url]',$mconfigs['wb_url'],'btext');
			tabfooter('提交');
